...
Uses the [`toybox-api`](https://github.com/sgarrity/ha-toybox) Python library for Meteor DDP communication.
...
| Repo | Purpose |
|------|---------|
| [`ha-toybox`](https://github.com/sgarrity/ha-toybox) | Standalone Python API client (Meteor DDP over WebSocket) |
